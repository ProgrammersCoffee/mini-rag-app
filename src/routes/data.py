...
@data_router.post("/upload/{project_id}")  # the Endpoint  
async def upload_data(project_id:str, file: UploadFile,app_settings:Settings =Depends(get_settings)):
 ...
 #  return { "signal" :result_signal } # will transport this to the variable "content"  
     
    if not is_valid:
        # OR  return JSONResponse(status_code=400)
    ...
    try:
        #open the file and write it to the disk
